...
@Named(value = "agendaController")
    ...
    private ScheduleEvent event = new Agenda();
    @EJB
...
//        eventModel = new DefaultScheduleModel();
//        eventModel.addEvent(new Agenda("Champions League Match", previousDay8Pm(), previousDay11Pm()));
//        eventModel.addEvent(new Agenda("Birthday Party", today1Pm(), today6Pm()));
//        eventModel.addEvent(new Agenda("Breakfast at Tiffanys", nextDay9Am(), nextDay11Am()));
//        eventModel.addEvent(new Agenda("Plant the new garden stuff", theDayAfter3Pm(), fourDaysLater3pm()));
//
...
//                addEvent(new Agenda("Lazy Event 1", random, random));
//
//                random = getRandomDate(start);
//                addEvent(new Agenda("Lazy Event 2", random, random));
//            }
//        };
    }
    ...
    public void onDateSelect(SelectEvent selectEvent) {
        event = new Agenda("", (Date) selectEvent.getObject(), (Date) selectEvent.getObject());
    }
